 ...
 *
 */
 	$assign_to_config['site_name']  = ORBIT_SHORT_NAME;
 	$assign_to_config['cp_url'] = 'http://localhost/allorbit/'.ORBIT_SHORT_NAME.'/admin.php';
 	$assign_to_config['site_url'] = 'http://localhost/allorbit/'.ORBIT_SHORT_NAME.'/';
